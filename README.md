...
pursuing a Cybersecurity and information Security
...
| certifications/ | Certification study notes and badges |
| writeups/ | CTF and security challenge writeups |

## Security Reminders

- Never commit passwords, API keys, or sensitive credentials.
- Never post private company data, patient data, or NDA-protected information.
- Do not post exam questions or proprietary vendor lab materials.
